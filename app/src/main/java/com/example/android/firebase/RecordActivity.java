...
//
//                                    DatabaseReference myRef1 = FirebaseDatabase.getInstance().getReference("Subjects");
//                                    myRef1.addListenerForSingleValueEvent(new ValueEventListener() {
//                                        @Override
//                                        public void onDataChange(DataSnapshot dataSnapshot) {
//                                            for(DataSnapshot subjectSnapshot : dataSnapshot.getChildren())
//                                            {
//                                                if((subjectSnapshot.getKey()).equals(currentSubject))
//                                                {
//                                                    Subject sub = subjectSnapshot.getValue(Subject.class);
//                                                    currentTeacher = sub.teacherName;
//                                                    break;
//                                                }
//                                            }
//                                        }
...
//
//
//                                    final DatabaseReference r = retrieveDatabaseStudent.child(batch);
//
...
//                                                    r.child(rollNumber).setValue(student);
