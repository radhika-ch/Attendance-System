...
//                                    Toast.makeText(getApplicationContext(), "Period found: "+subjectCode, Toast.LENGTH_SHORT).show();
                                        ...
                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                            for(DataSnapshot studentSnapshot : dataSnapshot.getChildren())
                                            {
                                                ...
                                                if(student.studentRollNumber.equals(rollNumber)) {
                                                    ...
                                                    retrieveDatabaseStudent.child(batch).child(rollNumber).setValue(student);
                                ...
                                {
                                    Toast.makeText(getApplicationContext(), "You do not have any classes right now", Toast.LENGTH_SHORT).show();
                                }
